...
exports.waitForText = function(selector, callback) {
	this.driver.waitForText(selector, this.driver.options.waitTimeout, false, callback);
};

exports.waitForNotText = function(selector, callback) {
	this.driver.waitForText(selector, this.driver.options.waitTimeout, true, callback);
};

exports.waitForContain = function(selector, text, callback) {
	this.driver.waitForContain(selector, text, this.driver.options.waitTimeout, false, callback);
};

exports.waitForNotContain = function(selector, text, callback) {
	this.driver.waitForContain(selector, text, this.driver.options.waitTimeout, true, callback);
};

exports.waitForMatch = function(selector, pattern, callback) {
	this.driver.waitForMatch(selector, pattern, this.driver.options.waitTimeout, false, callback);
};

exports.waitForNotMatch = function(selector, pattern, callback) {
  this.driver.waitForMatch(selector, pattern, this.driver.options.waitTimeout, true, callback);
};

exports.waitForSelected = function(selector, callback) {
	this.driver.waitForSelected(selector, this.driver.options.waitTimeout, false, callback);
};

exports.waitForNotSelected = function(selector, callback) {
	this.driver.waitForSelected(selector, this.driver.options.waitTimeout, true, callback);
};

exports.waitForExist = function(selector, callback) {
	this.driver.waitForExist(selector, this.driver.options.waitTimeout, false, callback);
};

exports.waitForNotExist = function(selector, callback) {
	this.driver.waitForExist(selector, this.driver.options.waitTimeout, true, callback);
};

exports.waitForEnabled = function(selector, callback) {
	this.driver.waitForEnabled(selector, this.driver.options.waitTimeout, false, callback);
};

exports.waitForDisabled = function(selector, callback) {
	this.driver.waitForEnabled(selector, this.driver.options.waitTimeout, true, callback);
};

exports.waitForValue = function(selector, callback) {
	this.driver.waitForValue(selector, this.driver.options.waitTimeout, false, callback);
};

exports.waitForNotValue = function(selector, callback) {
	this.driver.waitForValue(selector, this.driver.options.waitTimeout, true, callback);
};

exports.waitForVisible = function(selector, callback) {
	this.driver.waitForVisible(selector, this.driver.options.waitTimeout, false, callback);
};

exports.waitForInvisible = function(selector, callback) {
	this.driver.waitForVisible(selector, this.driver.options.waitTimeout, true, callback);
};

exports.waitForValueContain = function(selector, value, callback) {
	this.driver.waitForValueContain(selector, value, this.driver.options.waitTimeout, false, callback);
};

exports.waitForValueNotContain = function(selector, value, callback) {
	this.driver.waitForValueContain(selector, value, this.driver.options.waitTimeout, true, callback);
};

exports.waitForValueMatch = function(selector, pattern, callback) {
	this.driver.waitForValueMatch(selector, pattern, this.driver.options.waitTimeout, false, callback);
};

exports.waitForValueNotMatch = function(selector, pattern, callback) {
	this.driver.waitForValueMatch(selector, pattern, this.driver.options.waitTimeout, true, callback);
};
...
exports.waitForSelectedTimeout = function(timeout, selector, callback) {
	this.driver.waitForSelected(selector, timeout*1000, false, callback);
};
...
exports.waitForExistTimeout = function(timeout, selector, callback) {
	this.driver.waitForExist(selector, timeout*1000, false, callback);
};
