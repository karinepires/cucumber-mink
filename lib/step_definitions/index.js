...
function utility() {
  ...
  this.Given(/^I wait for "([^"]*)" to be selected$/,                           Ext.Utility.waitForSelected);
  ...
  this.Given(/^I wait for "([^"]*)" to not be visible$/,                        Ext.Utility.waitForInvisible);
  this.Given(/^I wait for "([^"]*)" to be invisible$/,                          Ext.Utility.waitForInvisible);
